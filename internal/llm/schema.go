...
- walk=true, если была прогулка; study=true, если занималась учёбой.
- useful: кратко опиши литературу, обучающее видео или другое полезное занятие.
- sweet и alcohol: true, если употребляла, false, если явно не было.
